...
namespace KsiegarniaOnline.Controllers
{
    public class BookCategoriesController : Controller
    {
        ...
        public BookCategoriesController(KsiegarniaOnlineContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CategoryID,CategoryBook")] BookCategory bookCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryID,CategoryBook")] BookCategory bookCategory)
        {
